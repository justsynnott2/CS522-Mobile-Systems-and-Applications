...
public class ViewPeerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView lastSeenView = findViewById(R.id.view_timestamp);
        TextView locationView = findViewById(R.id.view_location);

        userNameView.setText(getString(R.string.view_user_name, peer.name));
        lastSeenView.setText(getString(R.string.view_timestamp, formatTimestamp(peer.timestamp)));
        ...
        LiveData<List<Message>> liveMessages = peerViewModel.fetchMessagesFromPeer(peer);
        liveMessages.observe(this, messages -> {
            // Update your adapter with the list of messages
