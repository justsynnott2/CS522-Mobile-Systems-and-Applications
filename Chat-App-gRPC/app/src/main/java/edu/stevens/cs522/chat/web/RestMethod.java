...
public class RestMethod {
    ...
    public UploadObserver perform(SynchronizeRequest request, final DownloadObserver downloadObserver) {
        ...
        ChatServiceStub client = createStreamingClient(Settings.getServerUri(context), request);
        StreamObserver<UploadItem> requestProducer = client.sync(responseConsumer);
        /*
        ...
        return new UploadObserver() {
            ...
            public void onSync(long lastSequenceNumber, Double longitude, Double latitude) {
                // TODO
                requestProducer.onNext(UploadItem.newBuilder()
                        .setRequest(SyncRequest.newBuilder()
